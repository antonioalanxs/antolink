...
URL Shortener API built using [Spring Boot](https://spring.io/projects/spring-boot), [Kotlin](https://kotlinlang.org/), [Selenium](https://selenium.dev/) and [MongoDB](https://www.mongodb.com/).
...
Creates a new link based on the provided `LinkDTO`. **Requires the `Authorization-Code` header**.
